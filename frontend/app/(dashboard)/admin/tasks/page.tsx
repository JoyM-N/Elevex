...
import { listAdminTasks } from '@/lib/api/admin/tasks'
import {
  TaskFilters,
...
export default function AdminTasksPage() {
  ...
  const queryKey = useMemo(
    () => ['admin', 'tasks', { ...filters, taskType, page }],
  ...
  return (
    <div className="page-enter space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Assign and track intern work
          </p>
        </div>
        <Button render={<Link href="/admin/tasks/new" />} className="gap-1">
      ...
      {isLoading ? (
        ...
        <>
          <TaskList tasks={data?.data ?? []} mode={view} />
